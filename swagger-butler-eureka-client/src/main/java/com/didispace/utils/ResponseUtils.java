...
public class ResponseUtils {
	 ...
	 * * @param clazz * @return * * @author leechenxiang * @date 2016年4月22日
	 * 下午8:34:58
	 */
	...
	/**
	 * * * @Description: 没有object对象的转化 * @param json * @return * * @author
	 * leechenxiang * @date 2016年4月22日 下午8:35:21
	 */
	...
	/**
	 * * * @Description: Object是集合转化 * 需要转换的对象是一个list * @param jsonData * @param
	 * clazz * @return * * @author leechenxiang * @date 2016年4月22日 下午8:35:31
	 */
